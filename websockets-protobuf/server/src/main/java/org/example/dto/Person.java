...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 34: {
            if (!((mutable_bitField0_ & 0x00000008) != 0)) {
              phones_ = new java.util.ArrayList<Person.PhoneNumber>();
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public Person.PhoneType getType() {
      @SuppressWarnings("deprecation")
      Person.PhoneType result = Person.PhoneType.valueOf(type_);
      return result == null ? Person.PhoneType.HOME : result;
    }
